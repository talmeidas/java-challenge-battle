package io.github.talmeidas.battle.entrypoint.rest.common.metric;
...
public class LogExecutionTimeImpl {
    ...
    @SneakyThrows
    @Around("@annotation(io.github.talmeidas.battle.entrypoint.rest.common.metric.LogExecutionTime)")
